...
public class  ItemRegistry {
    ...
    public static final RegistryObject<Item> QuicheLorraine = ITEMS.register("quiche_lorraine",
            () -> new BlockItem(BlockRegistry.QuicheLorraine.get(), new Item.Properties().tab(Casualness_Delight.CasualnessDelightTab)));
    public static final RegistryObject<Item> StargazyPie = ITEMS.register("stargazy_pie",
            () -> new BlockItem(BlockRegistry.StargazyPie.get(), new Item.Properties().tab(Casualness_Delight.CasualnessDelightTab)));
    public static final RegistryObject<Item> StargazyPieSlice = ITEMS.register("stargazy_pie_slice",
            ()-> new SliceItem(new Item.Properties().food(FoodList.StargazyPieSlice).tab(Casualness_Delight.CasualnessDelightTab), false,true));
    public static final RegistryObject<Item> QuicheLorraineSlice = ITEMS.register("quiche_lorraine_slice",
            ()-> new SliceItem(new Item.Properties().food(FoodList.QuicheLorraineSlice).tab(Casualness_Delight.CasualnessDelightTab), true));
    public static final RegistryObject<Item> RawCheeseWheel = ITEMS.register("raw_cheese_wheel",
            () -> new BlockItem(BlockRegistry.RawCheeseWheel.get(), new Item.Properties().tab(Casualness_Delight.CasualnessDelightTab)));
