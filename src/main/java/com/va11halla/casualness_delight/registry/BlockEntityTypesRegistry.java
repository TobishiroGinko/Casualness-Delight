...
public enum BlockEntityTypesRegistry {
    ...
    public static void register() {
        ...
        for(int var2 = 0; var2 < var1; ++var2) {
            ...
            Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(CasualnessDelightFabric.MODID, value.pathName), value.get());
        }
    ...
    public String getId() {
        return Registries.BLOCK_ENTITY_TYPE.getId(this.get()).toString();
    }
}
