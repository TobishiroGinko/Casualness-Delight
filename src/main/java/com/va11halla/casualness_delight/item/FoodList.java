...
public class FoodList {
    public static final FoodComponent FishAndChips = new FoodComponent.Builder().hunger(14).saturationModifier(0.5F).statusEffect(new StatusEffectInstance(ModEffects.COMFORT.get(), 6000, 0), 1).build();
    public static final FoodComponent YorkshirePudding = new FoodComponent.Builder().hunger(5).saturationModifier(0.6F).build();
    public static final FoodComponent BeefNoodles = new FoodComponent.Builder().hunger(10).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(ModEffects.COMFORT.get(), 3600, 0), 1).build();
    ...
    public static final FoodComponent QuicheLorraineSlice = new FoodComponent.Builder().hunger(5).saturationModifier(0.5F).statusEffect(new StatusEffectInstance(ModEffects.COMFORT.get(), 1800, 0), 1).statusEffect(new StatusEffectInstance(ModEffects.NOURISHMENT.get(), 1200, 0), 1).build();
    ...
    public static final FoodComponent BowlOfPaperWrappedFish = new FoodComponent.Builder().hunger(10).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(ModEffects.COMFORT.get(), 3600, 0),1).build();
    public static final FoodComponent PotatoBoboChicken = new FoodComponent.Builder().hunger(4).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(ModEffects.NOURISHMENT.get(), 600, 0), 1).build();
    public static final FoodComponent ChickenBoboChicken = new FoodComponent.Builder().hunger(4).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(ModEffects.NOURISHMENT.get(), 600, 0), 1).build();
    public static final FoodComponent CabbageBoboChicken = new FoodComponent.Builder().hunger(4).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(ModEffects.NOURISHMENT.get(), 600, 0), 1).build();
    public static final FoodComponent PotatoChip = new FoodComponent.Builder().hunger(4).saturationModifier(1.0F).build();
    public static final FoodComponent SpringRoll = new FoodComponent.Builder().hunger(6).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(ModEffects.NOURISHMENT.get(), 600, 0), 1).build();
    ...
    public static final FoodComponent FriedDumpling = new FoodComponent.Builder().hunger(16).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(ModEffects.NOURISHMENT.get(), 3600, 0), 1).build();
