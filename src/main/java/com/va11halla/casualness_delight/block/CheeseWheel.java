...
public class CheeseWheel extends Block {
    ...
    public void onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (player.getMainHandStack().isIn(TagsRegistry.KNIVES)) {
            com.nhoryzon.mc.farmersdelight.block.PieBlock pieBlock = (com.nhoryzon.mc.farmersdelight.block.PieBlock)state.getBlock();
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        return itemstack.isIn(TagsRegistry.KNIVES) ? this.cutSlice(world, pos, state) : this.consumeBite(world, pos, state, player);
    }
