...
//看到这
    ...
    public @Nullable BlockState getPlacementState(ItemPlacementContext context) {
        return (BlockState)((BlockState)this.getDefaultState().with(FACING, context.getPlayerFacing())).with(SUPPORT, this.getTrayState(context.getWorld(), context.getBlockPos()));
    }
