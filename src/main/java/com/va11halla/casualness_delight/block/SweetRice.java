...
public class SweetRice extends FeastBlock {
    ...
    public SweetRice() {
        super(FabricBlockSettings.copyOf(Blocks.CAKE), ItemRegistry.BowlOfSweetRice.get(), true);
    }
    ...
    static {
        PIE_SHAPE = VoxelShapes.combine(PLATE_SHAPE, Block.createCuboidShape(3.0, 1.0, 3.0, 13.0, 4.0, 13.0), BooleanBiFunction.OR);
    }
}
